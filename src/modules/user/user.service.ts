...
const createUser = async(payload: Record<string, unknown>)=>{
    ...
    const result = await pool.query(`INSERT INTO users(name, role, email, password) VALUES($1,$2,$3,$4) RETURNING *`, [name, role, email, hasedPassword]);
    return result;
};
const getUser = async ()=>{
...
export const userServices = {
    createUser, getUser, getSingleUser, updateSingleUser, delSingleUser,
};
